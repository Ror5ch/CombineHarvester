...
if [ ${3} = "0" ]; then
    MorphingSM2016_flexible --output_folder="data_isGGH1_$4_mergedBins_withSyst_MELAVBF" --postfix="-2D_MELAVBF_isGGH1_$4_mergedBins" --control_region=0 --manual_rebin=false --real_data=false --mm_fit=false --ttbar_fit=false --embedded=false --jetfakes=true --shapeSyst=true --year=$2
else
    MorphingSM2016_flexible --output_folder="data_isGGH1_$4_mergedBins_withSyst_MELAVBF" --postfix="-2D_MELAVBF_isGGH1_$4_mergedBins" --control_region=0 --manual_rebin=false --real_data=false --mm_fit=false --ttbar_fit=false --embedded=true --jetfakes=true --shapeSyst=true --year=$2
fi

cd output/data_isGGH1_$4_mergedBins_withSyst_MELAVBF
...
cp higgsCombine1D_scan_fa3_ggH_$1_$2.MultiDimFit.mH125.root /eos/home-s/senka/HTT/scans/htt_newSkims/higgsCombine1D_scan_fa3_$1_$2_isGGH1_$4_withSyst_optimized.MultiDimFit.mH125.root
