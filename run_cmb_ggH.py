...
outputFile=outputFile.replace('.txt','_'+inputString+'_'+par+'_ggH_cmb.txt')
f_out = open(outputFile, 'w')

cmd="""

cd $CMSSW_BASE/src/CombineHarvester/output/data_isGGH1_MANUAL_optBins_fa3_ggHint_AutoRebin_swaped_newFSA_HWWSMPowheg_Syst_mergedBins_withSyst_MELAVBF/cmb
cp /data6/Users/knam/13TeV/HTTAC/doyeong/output_Nov23/data_2D_htt_tt_emb_sys_fa3ggH/tt/125/*txt 125/
...
cp /data6/Users/knam/13TeV/HTTAC/doyeong/output_Nov23/data_2D_htt_tt_emb_sys_fa3ggH/tt/common/htt_input_2016.root common/htt_tt_input_2016.root
cp /data6/Users/knam/13TeV/HTTAC/doyeong/output_Nov23/data_2D_htt_tt_emb_sys_fa3ggH/tt/common/htt_input_2017.root common/htt_tt_input_2017.root
cp /data6/Users/knam/13TeV/HTTAC/doyeong/output_Nov23/data_2D_htt_tt_emb_sys_fa3ggH/tt/common/htt_input_2018.root common/htt_tt_input_2018.root

cd 125

sed -i 's/htt_input_/htt_em_input_/g' htt_em_*_201*.txt
...
sed -i '/muES/d' htt_em_9_2016*
sed -i '/muES/d' htt_em_10_2016*
