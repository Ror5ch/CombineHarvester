...
for k1 in dirList: # loop over categories
    ...
    for histo in histoList:
	    ...
	    #if ('_l1.' in inputfile and channel=='mt' and year!="_2016"):
	    #	if (((( "bin3" in nom) and year=="_2018")) or (("bin2" in nom or "bin4" in nom) and year=="_2017")):
		#        binsD2jet=[0.,0.625,1.0]	
                #        if "data_obs" in h3.GetName():
                #                print "    %s => change D2jet bin %s"%(nom,binsD2jet)
                #elif (((("bin2" in nom) and year=="_2018"))):
                #        binsD2jet=[0.,0.25,1.0]
                #        if "data_obs" in h3.GetName():
                #                print "    %s => change D2jet bin %s"%(nom,binsD2jet)
		#else:
		#	binsD2jet=binsD2jet_origi
	    
	    #if ('_l1.' in inputfile and channel=='mt' and year=="_2018"):
	    #	if "bin2" in nom:
	    #		binsD2jet=[0.,0.25,1.0]
	    #	else:
            #            binsD2jet=binsD2jet_origi
