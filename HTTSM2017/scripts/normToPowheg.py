...
if chn=='tt':
    ...
    vbf_dir_names=[chn+"_vbf_ggHMELA_bin1",chn+"_vbf_ggHMELA_bin2",chn+"_vbf_ggHMELA_bin3",chn+"_vbf_ggHMELA_bin4"]   
vbf_dir_names=[chn+"_vbf_ggHMELA_bin1",chn+"_vbf_ggHMELA_bin2",chn+"_vbf_ggHMELA_bin3",chn+"_vbf_ggHMELA_bin4"]

if (has_DCP_bins==1):
    vbf_dir_names=[chn+"_vbf_ggHMELA_bin1_DCPp",chn+"_vbf_ggHMELA_bin2_DCPp",chn+"_vbf_ggHMELA_bin3_DCPp",chn+"_vbf_ggHMELA_bin4_DCPp",chn+"_vbf_ggHMELA_bin1_DCPm",chn+"_vbf_ggHMELA_bin2_DCPm",chn+"_vbf_ggHMELA_bin3_DCPm",chn+"_vbf_ggHMELA_bin4_DCPm"]
    #if chn=='em':
    #	    vbf_dir_names=[chn+"_vbf_ggHMELA_bin1",chn+"_vbf_ggHMELA_bin2",chn+"_vbf_ggHMELA_bin3",chn+"_vbf_ggHMELA_bin4",chn+"_vbf_ggHMELA_bin5",chn+"_vbf_ggHMELA_bin6",chn+"_vbf_ggHMELA_bin7",chn+"_vbf_ggHMELA_bin8"]

if singleVBFdir==1:
	vbf_dir_names=[chn+"_vbf"]
...
#if (year==2018 and chn!='tt'):
#    name_SM_ggH_JHU="JHU__reweighted_GGH2Jets_0PM125"


'''
if chn!='tt':
	name_SM_ggH_JHU="ggh_madgraph_twojet" 	
        name_PS_ggH_JHU="ggh_madgraph_PS_twojet"   
'''
...
for k1 in vbf_dir_names:
    ...
    print " looking for %s dir %s and histo %s "%(file.GetName(),k1,name_SM_qqH_powheg)
    #file.cd(vbf_dir_names)
...
#                 h3.Scale(h_SM_qqH_powheg.Integral()/h3.Integral())
		...
		#print " saving ggH SM/PS/maxmix (%s) in dir %s"%(name_histo_maxmix,nom)
		#print " =============================> name_histo= %s, name_histo_PS=%s, name_histo_maxmix=%s"%(name_histo,name_histo_PS,name_histo_maxmix)
...
#            if "reweighted_GGH2Jets_" in name_histo and "to" in nom:
	    ...
	    if "reweighted_GGH2Jets_" in name_histo and ("vbf" in nom):
	       ...
	       name_histo=name_histo.replace("reweighted_GGH2Jets_0M","GGH2Jets_pseudoscalar_M")
               name_histo=name_histo.replace("reweighted_GGH2Jets_Mf05ph0","GGH2Jets_pseudoscalar_Mf05ph0")
               h3.SetName(name_histo)     
               h3.Write(name_histo)     
