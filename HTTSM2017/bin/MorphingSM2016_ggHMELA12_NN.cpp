...
int main(int argc, char** argv) {
    ...
    vector<string> lep_channels = {"em", "et", "mt", "tt"};
    for (auto& lep_channel : lep_channels) {
      cats[lep_channel] = {
        {1, lep_channel+"_0jet"},
        {2, lep_channel+"_boosted"},
        {3, lep_channel+"_vbf_ggHMELA_bin1_NN_bin1"},
        {4, lep_channel+"_vbf_ggHMELA_bin2_NN_bin1"},
        {5, lep_channel+"_vbf_ggHMELA_bin3_NN_bin1"},
        {6, lep_channel+"_vbf_ggHMELA_bin4_NN_bin1"},
        {7, lep_channel+"_vbf_ggHMELA_bin5_NN_bin1"},
        {8, lep_channel+"_vbf_ggHMELA_bin6_NN_bin1"},
        // {9, lep_channel+"_vbf_ggHMELA_bin7_NN_bin1"},
        // {10, lep_channel+"_vbf_ggHMELA_bin8_NN_bin1"},
        // {11, lep_channel+"_vbf_ggHMELA_bin9_NN_bin1"},
        // {12, lep_channel+"_vbf_ggHMELA_bin10_NN_bin1"},
        // {13, lep_channel+"_vbf_ggHMELA_bin11_NN_bin1"},
        // {14, lep_channel+"_vbf_ggHMELA_bin12_NN_bin1"},
        // {15, lep_channel+"_vbf_ggHMELA_bin1_NN_bin2"},
        // {16, lep_channel+"_vbf_ggHMELA_bin2_NN_bin2"},
        // {17, lep_channel+"_vbf_ggHMELA_bin3_NN_bin2"},
        // {18, lep_channel+"_vbf_ggHMELA_bin4_NN_bin2"},
        // {19, lep_channel+"_vbf_ggHMELA_bin5_NN_bin2"},
        // {20, lep_channel+"_vbf_ggHMELA_bin6_NN_bin2"}
        // {21, lep_channel+"_vbf_ggHMELA_bin7_NN_bin2"},
        // {22, lep_channel+"_vbf_ggHMELA_bin8_NN_bin2"},
        // {23, lep_channel+"_vbf_ggHMELA_bin9_NN_bin2"},
        // {24, lep_channel+"_vbf_ggHMELA_bin10_NN_bin2"},
        // {25, lep_channel+"_vbf_ggHMELA_bin11_NN_bin2"},
        // {26, lep_channel+"_vbf_ggHMELA_bin12_NN_bin2"}
        // {25, lep_channel+"_vbf_ggHMELA_bin1_NN_bin3"},
        // {26, lep_channel+"_vbf_ggHMELA_bin2_NN_bin3"},
        // {27, lep_channel+"_vbf_ggHMELA_bin3_NN_bin3"},
        // {28, lep_channel+"_vbf_ggHMELA_bin4_NN_bin3"},
        // {29, lep_channel+"_vbf_ggHMELA_bin5_NN_bin3"},
        // {30, lep_channel+"_vbf_ggHMELA_bin6_NN_bin3"}
        // {31, lep_channel+"_vbf_ggHMELA_bin7_NN_bin3"},
        // {32, lep_channel+"_vbf_ggHMELA_bin8_NN_bin3"}
        // {33, lep_channel+"_vbf_ggHMELA_bin9_NN_bin3"},
        // {34, lep_channel+"_vbf_ggHMELA_bin10_NN_bin3"}
      };
    }
    ...
    vector<string> sig_procs = {
      "GGH2Jets_sm_M","GGH2Jets_pseudoscalar_M",/*"GGH2Jets_pseudoscalar_Mf05ph0",*/"reweighted_WH_htt_0PM","reweighted_ZH_htt_0PM",
      "reweighted_qqH_htt_0PM","reweighted_qqH_htt_0M","reweighted_ZH_htt_0M","reweighted_WH_htt_0M","reweighted_qqH_htt_0Mf05ph0",
      "reweighted_ZH_htt_0Mf05ph0","reweighted_WH_htt_0Mf05ph0"
    };
    ...
    if (control_region > 0){
      cb.AddProcesses(  {"*"}, {"htt"}, {"13TeV"}, {"et"}, {"W"}, cats["et"], false);
      cb.AddProcesses(  {"*"}, {"htt"}, {"13TeV"}, {"mt"}, {"W"}, cats["mt"], false);
    }
    ...
    // ch::AddSMRun2Systematics_ggHMELA_rw(cb, control_region, mm_fit, ttbar_fit);
    ch::AddSMRun2Systematics_ggHMELA_rw(cb,tt_cate_count,mt_cate_count, control_region, do_shapeSyst, mm_fit, ttbar_fit);
    ...
    for (auto chn : chns) {
        ...
        // writer.WriteCards("htt_"+chn+"_9_13TeV", cb.cp().channel({chn}).bin_id({9}));
        // writer.WriteCards("htt_"+chn+"_10_13TeV", cb.cp().channel({chn}).bin_id({10}));
        ...
        // writer.WriteCards("htt_"+chn+"_19_13TeV", cb.cp().channel({chn}).bin_id({19}));
        // writer.WriteCards("htt_"+chn+"_20_13TeV", cb.cp().channel({chn}).bin_id({20}));
        // writer.WriteCards("htt_"+chn+"_21_13TeV", cb.cp().channel({chn}).bin_id({21}));
        // writer.WriteCards("htt_"+chn+"_22_13TeV", cb.cp().channel({chn}).bin_id({22}));
        // writer.WriteCards("htt_"+chn+"_23_13TeV", cb.cp().channel({chn}).bin_id({23}));
        // writer.WriteCards("htt_"+chn+"_24_13TeV", cb.cp().channel({chn}).bin_id({24}));
        // writer.WriteCards("htt_"+chn+"_25_13TeV", cb.cp().channel({chn}).bin_id({25}));
        // writer.WriteCards("htt_"+chn+"_26_13TeV", cb.cp().channel({chn}).bin_id({26}));
        // writer.WriteCards("htt_"+chn+"_27_13TeV", cb.cp().channel({chn}).bin_id({27}));
        // writer.WriteCards("htt_"+chn+"_28_13TeV", cb.cp().channel({chn}).bin_id({28}));
        // writer.WriteCards("htt_"+chn+"_29_13TeV", cb.cp().channel({chn}).bin_id({29}));
        // writer.WriteCards("htt_"+chn+"_30_13TeV", cb.cp().channel({chn}).bin_id({30}));
        ...
        // writer.WriteCards("htt_"+chn+"_31_13TeV", cb.cp().channel({chn}).bin_id({33}));
        // writer.WriteCards("htt_"+chn+"_32_13TeV", cb.cp().channel({chn}).bin_id({34}));
        ...
        for (auto mmm : masses){
            ...
            if (control_region > 0){
                if (ch::contains({"et", "mt"}, chn)) {
                    cb.cp().channel({chn}).bin_id({40}).mass({"$MASS", "*"}).WriteDatacard(output_prefix + output_folder +"/"+chn+"/"+mmm+ "/htt_"+chn+"_40_13TeV.txt", output_prefix + output_folder +"/"+chn+ "/common/htt_input"+chn+"30.root");
                    cb.cp().channel({chn}).bin_id({41}).mass({"$MASS", "*"}).WriteDatacard(output_prefix + output_folder +"/"+chn+"/"+mmm+ "/htt_"+chn+"_41_13TeV.txt", output_prefix + output_folder +"/"+chn+ "/common/htt_input"+chn+"31.root");
                    ...
                    cb.cp().channel({chn}).bin_id({43}).mass({"$MASS", "*"}).WriteDatacard(output_prefix + output_folder +"/"+chn+"/"+mmm+ "/htt_"+chn+"_43_13TeV.txt", output_prefix + output_folder +"/"+chn+ "/common/htt_input"+chn+"33.root");
                    cb.cp().channel({chn}).bin_id({44}).mass({"$MASS", "*"}).WriteDatacard(output_prefix + output_folder +"/"+chn+"/"+mmm+ "/htt_"+chn+"_44_13TeV.txt", output_prefix + output_folder +"/"+chn+ "/common/htt_input"+chn+"34.root");
                    ...
                    cb.cp().channel({chn}).bin_id({40}).mass({"$MASS", "*"}).WriteDatacard(output_prefix + output_folder +"/cmb/"+mmm+ "/htt_"+chn+"_40_13TeV.txt", output_prefix + output_folder +"/"+chn+ "/common/htt_input"+chn+"30.root");
                    cb.cp().channel({chn}).bin_id({41}).mass({"$MASS", "*"}).WriteDatacard(output_prefix + output_folder +"/cmb/"+mmm+ "/htt_"+chn+"_41_13TeV.txt", output_prefix + output_folder +"/"+chn+ "/common/htt_input"+chn+"31.root");
                    ...
                    cb.cp().channel({chn}).bin_id({43}).mass({"$MASS", "*"}).WriteDatacard(output_prefix + output_folder +"/cmb/"+mmm+ "/htt_"+chn+"_43_13TeV.txt", output_prefix + output_folder +"/"+chn+ "/common/htt_input"+chn+"33.root");
                    cb.cp().channel({chn}).bin_id({44}).mass({"$MASS", "*"}).WriteDatacard(output_prefix + output_folder +"/cmb/"+mmm+ "/htt_"+chn+"_44_13TeV.txt", output_prefix + output_folder +"/"+chn+ "/common/htt_input"+chn+"34.root");
