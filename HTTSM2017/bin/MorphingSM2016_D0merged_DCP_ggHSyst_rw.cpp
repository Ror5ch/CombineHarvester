...
//    VString chns = {"mt","tt"};
    ...
    cats["em"] = {
        {1, "em_0jet"},
        {2, "em_boosted"},
        {3, "em_vbf_D0_0p0to0p2_DCPm"},
        {4, "em_vbf_D0_0p2to0p4_DCPm"},
        {5, "em_vbf_D0_0p4to0p8_DCPm"},
        {6, "em_vbf_D0_0p8to1p0_DCPm"},
        {7, "em_vbf_D0_0p0to0p2_DCPp"},
        {8, "em_vbf_D0_0p2to0p4_DCPp"},
        {9, "em_vbf_D0_0p4to0p8_DCPp"},
        {10, "em_vbf_D0_0p8to1p0_DCPp"}
    };

    cats["et"] = {
        {1, "et_0jet"},
        {2, "et_boosted"},
        {3, "et_vbf_D0_0p0to0p2_DCPm"},
        {4, "et_vbf_D0_0p2to0p4_DCPm"},
        {5, "et_vbf_D0_0p4to0p8_DCPm"},
        {6, "et_vbf_D0_0p8to1p0_DCPm"},
        {7, "et_vbf_D0_0p0to0p2_DCPp"},
        {8, "et_vbf_D0_0p2to0p4_DCPp"},
        {9, "et_vbf_D0_0p4to0p8_DCPp"},
        {10, "et_vbf_D0_0p8to1p0_DCPp"}
    };
    
    cats["mt"] = {
        {1, "mt_0jet"},
        {2, "mt_boosted"},
        {3, "mt_vbf_D0_0p0to0p2_DCPm"},
        {4, "mt_vbf_D0_0p2to0p4_DCPm"},
        {5, "mt_vbf_D0_0p4to0p8_DCPm"},
        {6, "mt_vbf_D0_0p8to1p0_DCPm"},
        {7, "mt_vbf_D0_0p0to0p2_DCPp"},
        {8, "mt_vbf_D0_0p2to0p4_DCPp"},
        {9, "mt_vbf_D0_0p4to0p8_DCPp"},
        {10, "mt_vbf_D0_0p8to1p0_DCPp"}
    };
    ...
    */
    ...
    cats["tt"] = {        
        {1, "tt_0jet"},
        {2, "tt_boosted"},
        {3, "tt_vbf_D0_0to0p2_DCPm"},
        {4, "tt_vbf_D0_0p2to0p4_DCPm"},
        {5, "tt_vbf_D0_0p4to0p8_DCPm"},
        {6, "tt_vbf_D0_0p8to1_DCPm"},
        {7, "tt_vbf_D0_0to0p2_DCPp"},
        {8, "tt_vbf_D0_0p2to0p4_DCPp"},
        {9, "tt_vbf_D0_0p4to0p8_DCPp"},
        {10, "tt_vbf_D0_0p8to1_DCPp"}
    };
...
//                queue.push_back(make_pair(binid+5,chn+"_antiiso_vbf_cr"));
    ...
    vector<string> sig_procs = {"GGH2Jets_sm_M","GGH2Jets_pseudoscalar_M","GGH2Jets_pseudoscalar_Mf05ph0","reweighted_WH_htt_0PM","reweighted_ZH_htt_0PM","reweighted_qqH_htt_0PM","reweighted_qqH_htt_0M","reweighted_ZH_htt_0M","reweighted_WH_htt_0M","reweighted_qqH_htt_0Mf05ph0","reweighted_ZH_htt_0Mf05ph0","reweighted_WH_htt_0Mf05ph0"};
