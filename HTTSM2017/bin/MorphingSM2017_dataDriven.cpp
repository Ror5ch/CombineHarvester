...
// VString chns = {"mt"};
 VString chns = {"et"};
    ...
    if (do_jetfakes){
      ...
      //bkg_procs["mt"] = {"ZL", "TTT", "VV", "JetFakes"}; // Doyeong
      bkg_procs["mt"] = {"ZL", "TTT", "VVT", "jetFakes"}; // Tyler
      bkg_procs["tt"] = {"ZL", "TTT", "VVT", "JetFakes"};
    }else{
      bkg_procs["et"] = {"QCD", "ZL", "ZJ","TTT","TTJ",   "VV"};
      bkg_procs["mt"] = {"QCD", "ZL", "ZJ","TTT","TTJ",   "VV"};
      bkg_procs["tt"] = {"W", "QCD", "ZL", "ZJ","TTT","TTJ",  "VVT","VVJ"};
...
//      bkg_procs["mt"].push_back("embed"); // Tyler
      ...
      bkg_procs["et"].push_back("EWKZ");
      bkg_procs["mt"].push_back("EWKZ");
      bkg_procs["tt"].push_back("EWKZ");
